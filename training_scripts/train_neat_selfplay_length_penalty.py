...
def create_eval_function(opponent_genome, config):
    ...
    def eval_genomes(genomes: list[neat.DefaultGenome], config: neat.Config) -> None:
        ...
        for genome_id, genome in genomes:
            ...
            # adjusted score with length penalty 
            length_penalty = 1 - length / 3000
            genome.fitness = score * length_penalty
...
for pop in range(num_populations):
    ...
    with open(zoo_path + f'train_neat_selfplay_length_penalty_{pop}.pkl', 'wb') as f:
